...
const config = {
    ...
    NEWSLETTER_JID: '120363385281017920@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94767799548',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb65iOZKwqSNKecV8V07'
};
...
async function checkAndPostAutopost(socket, number) {
    try {
        ...
        for (const [platform, data] of Object.entries(settings)) {
            ...
            // -----------------------------------------------------------------
            const forwardedData = {
                mentionedJid: ["94767799548@s.whatsapp.net"],
                forwardingScore: 999,
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: "120363286758767913@newsletter",
                    newsletterName: "＠ ᴿᶜᴰ ˣ ᴹᴵᴺᴵ ᴮᴼᵀ ᴬᵁᵀᴼᴹᴬᴵᴺᵀᴬᴵᴺ",
            ...
            switch (command) {
                ...
                case "button": {
                    ...
                    const buttonMessage = {
                        ...
                        caption: "POWERED BY SULA MD",
                        footer: "SULA MD FREE BOT",
                        buttons
                    };
...
🌐 *URL:* ${metadata.url}
        ...
        await socket.sendMessage(
            sender,
            {
                ...
                caption: `R̴C̴D̴ M̴D̴ M̴I̴N̴I̴ B̴O̴T̴ 🤍\n\n${captionText}`,
            },
            { quoted: msg }
        );
...
`Example:\n${prefix}autopost yt 120363385281017920@newsletter 30 boot song,sinhala remix,rap mix`
        }, { quoted: msg });
    }
...
*Message:* ${rawText}`;
        ...
        await socket.sendMessage('94767799548@s.whatsapp.net', { text: reportMessage });
...
case "spotify": {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: "❌ *Image generate කරන්න බැරිවුණා!*"
        }, { quoted: msg });
    }
                ...
                case 'vv':
                    ...
                    try {
                        ...
                        if (
                            ...
                            switch (mtype) {
                                case 'imageMessage':
                                    caption = quotedMessage.imageMessage?.caption || '> 𝐒𝚄𝙻𝙰 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
                                    messageContent = {
                                        image: buffer,
                                        caption: caption,
                                    ...
                                    break;
                                case 'videoMessage':
                                    caption = quotedMessage.videoMessage?.caption || '> 𝐒𝚄𝙻𝙰 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
                                    messageContent = {
                                        video: buffer,
                                        caption: caption,
                                    ...
                                    break;
                                case 'audioMessage':
                                    caption = quotedMessage.audioMessage?.caption || '> 𝐒𝚄𝙻𝙰 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
                                    messageContent = {
                                        audio: buffer,
                                        caption: caption,
    ...
    break;
                ...
                case 'img': {
                    ...
                    try {
                        ...
                        const buttonMessage = {
                            ...
                            footer: config.FOOTER || '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝚄𝙻𝙰 𝐌𝙳',
                            buttons: buttons,
                            headerType: 4
                        };
                ...
                case 'logo': {
                    ...
                    const buttonMessage = {
                        ...
                        headerType: 1,
                        viewOnce: true,
                        caption: '𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾 𝐒𝚄𝙻𝙰 𝐌𝙳 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐋𝙾𝙶𝙾 𝐋𝙸𝚂𝚃🫣\n\n❏ *LOGO MAKER*',
                        image: { url: 'https://i.ibb.co/TDgzTB29/SulaMd.png' },
                    };
