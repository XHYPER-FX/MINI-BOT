...
const commands = {
    button: {
        ...
        async execute(socket, msg, sender, from, args, isOwner, isGroup, reply, m, quoted, body, sanitizedNumber, number) {
            ...
            const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝚄𝙻𝙰 𝐌𝙳';
            const footerText = '𝐒𝚄𝙻𝙰 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
...
`;
            ...
            await socket.sendMessage(from, {
                ...
                viewOnce: true,
                image: { url: "https://i.ibb.co/TDgzTB29/SulaMd.png" },
                caption: `𝐒𝚄𝙻𝙰 𝐒𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐋𝙸𝚂𝚃 𝐌𝙴𝙽𝚄\n\n${captionText}`,
            }, { quoted: msg });
        }
    },
        ...
        async execute(socket, msg, sender, from, args, isOwner, isGroup, reply, m, quoted, body, sanitizedNumber, number) {
            ...
            try {
                ...
                if (
                    ...
                    switch (mtype) {
                        case 'imageMessage':
                            caption = quotedMessage.imageMessage?.caption || '> 𝐒𝚄𝙻𝙰 𝐒𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
                            messageContent = {
                                image: buffer,
                                caption: caption,
                            ...
                            break;
                        case 'videoMessage':
                            caption = quotedMessage.videoMessage?.caption || '> 𝐒𝚄𝙻𝙰 𝐒𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
                            messageContent = {
                                video: buffer,
                                caption: caption,
                            ...
                            break;
                        case 'audioMessage':
                            caption = quotedMessage.audioMessage?.caption || '> 𝐒𝚄𝙻𝙰 𝐒𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
                            messageContent = {
                                audio: buffer,
                                caption: caption,
    ...
    fc: {
        ...
        async execute(socket, msg, sender, from, args, isOwner, isGroup, reply, m, quoted, body, sanitizedNumber, number) {
            if (args.length === 0) {
                return await socket.sendMessage(sender, {
                    text: '❗ Please provide a channel JID.\n\nExample:\n.fc 120363396379901844@newsletter'
                });
            }
    ...
    pair: {
        ...
        async execute(socket, msg, sender, from, args, isOwner, isGroup, reply, m, quoted, body, sanitizedNumber, number) {
            ...
            try {
                ...
                await socket.sendMessage(sender, {
                    text: `> *𝐒𝚄𝙻𝙰 𝐒𝙳 𝐌𝙸𝙽𝙸 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
                }, { quoted: msg });
        ...
        async execute(socket, msg, sender, from, args, isOwner, isGroup, reply, m, quoted, body, sanitizedNumber, number) {
            ...
            try {
                ...
                const buttonMessage = {
                    ...
                    footer: config.FOOTER || '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝚄𝙻𝙰 𝐒𝙳',
                    buttons: buttons,
                    headerType: 4
                };
    ...
    logo: {
        ...
        async execute(socket, msg, sender, from, args, isOwner, isGroup, reply, m, quoted, body, sanitizedNumber, number) {
            ...
            const buttonMessage = {
                ...
                headerType: 1,
                viewOnce: true,
                caption: '𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾 𝐒𝚄𝙻𝙰 𝐒𝙳 𝐌𝙸𝙽𝙸 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙳🫣\n\n❏ *LOGO MAKER*',
                image: { url: 'https://i.ibb.co/TDgzTB29/SulaMd.png' },
            };
